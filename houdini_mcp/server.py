...
def list_children(
    ...
    """
    return tools.list_children(node_path, recursive, max_depth, max_nodes, HOUDINI_HOST, HOUDINI_PORT)
...
def connect_nodes(
    ...
    """
    return tools.connect_nodes(src_path, dst_path, dst_input_index, src_output_index, HOUDINI_HOST, HOUDINI_PORT)
...
def get_geo_summary(
    ...
    """
    return tools.get_geo_summary(node_path, max_sample_points, include_attributes, 
                                 include_groups, HOUDINI_HOST, HOUDINI_PORT)
