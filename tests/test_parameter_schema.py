...
from tests.conftest import MockHouModule, MockHouNode
...
class MockParmTemplate:
    ...
    def __init__(
        ...
        self._default_value = (
            default_value if default_value is not None else ([0.0] * num_components)
        )
...
class TestGetParameterSchema:
    ...
    def test_get_parameter_schema_single_float(self, mock_connection):
        ...
        sphere = MockHouNode(
            path="/obj/geo1/sphere1", name="sphere1", node_type="sphere", params={"radx": 2.5}
        )
    ...
    def test_get_parameter_schema_vector(self, mock_connection):
        ...
        geo = MockHouNode(
            path="/obj/geo1", name="geo1", node_type="geo", params={"t": [1.0, 2.0, 3.0]}
        )
    ...
    def test_get_parameter_schema_menu(self, mock_connection):
        ...
        sphere = MockHouNode(
            path="/obj/geo1/sphere1", name="sphere1", node_type="sphere", params={"type": 0}
        )
        mock_hou.add_node(sphere)
    ...
    def test_get_parameter_schema_all_parameters(self, mock_connection):
        ...
        templates = [
            MockParmTemplate(
                "radx",
                "Radius X",
                mock_hou.parmTemplateType.Float,
                default_value=[1.0],
                min_val=0.0,
            ),
            MockParmTemplate(
            ...
            MockParmTemplate(
                "type",
                "Type",
                mock_hou.parmTemplateType.Menu,
                default_value=[0],
                menu_items=["poly", "mesh"],
    ...
    def test_get_parameter_schema_max_parms_limit(self, mock_connection):
        ...
        templates = [
            MockParmTemplate(
                f"parm{i}", f"Parameter {i}", mock_hou.parmTemplateType.Float, default_value=[0.0]
            )
            for i in range(20)
        ]
    ...
    def test_get_parameter_schema_skip_folders(self, mock_connection):
        ...
        sphere = MockHouNode(
            path="/obj/geo1/sphere1", name="sphere1", node_type="sphere", params={"radx": 1.0}
        )
        mock_hou.add_node(sphere)
        ...
        templates = [
            ...
            MockParmTemplate(
                "radx", "Radius X", mock_hou.parmTemplateType.Float, default_value=[1.0]
            ),
    ...
    def test_get_parameter_schema_toggle_parameter(self, mock_connection):
        ...
        node = MockHouNode(
            path="/obj/geo1/box1", name="box1", node_type="box", params={"consolidatepts": True}
        )
    ...
    def test_get_parameter_schema_int_parameter(self, mock_connection):
        ...
        grid = MockHouNode(
            path="/obj/geo1/grid1", name="grid1", node_type="grid", params={"rows": 10}
        )
